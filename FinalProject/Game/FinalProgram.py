...
TIC = pygame.image.load("Images/TicTacToe.png")
TIC = pygame.transform.scale(TIC, (450, 210))
START_BUTTON_IMG = pygame.image.load("Images/STAR.png")
...
def show_rules_screen():
    ...
    rules_font = pygame.font.Font("Text/Mario-Kart-DS.ttf", 55)
    text1 = rules_font.render("Welcome   To   Tic   Tac   Toe", True, (0, 0, 0))
    rules_font = pygame.font.Font("Text/VerilySerifMono.otf", 20)
    ...
    rules_font = pygame.font.Font("Text/mario.ttf", 75)
...
def show_result_screen(result):
    ...
    SCREEN.fill(BG_COLOR)
    rules_font = pygame.font.Font("Text/mario.ttf", 200)
    textGame = rules_font.render("H", True, (0, 0, 0))
    font = pygame.font.Font("Text/VerilySerifMono.otf", 80)
    if result == "DRAW":
    ...
    # Display Score
    font = pygame.font.Font("Text/VerilySerifMono.otf", 30)
    ...
    # Restart Button
    font = pygame.font.Font("Text/Mario-Kart-DS.ttf", 45)
